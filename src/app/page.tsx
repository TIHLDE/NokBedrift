...
export default function Hjem() {
  return (
    <div className="relative flex flex-col items-center justify-center w-full overflow-x-clip">
        ...
        <Card>
          <div className="grid gap-6 sm:gap-8 md:grid-cols-5 place-items-center">
            <div className="md:col-span-2">
              <h2 className="mb-2 text-2xl sm:text-4xl font-bold text-pretty">
                Bedriftspresentasjoner
              </h2>
            ...
            <div className="flex items-center justify-center md:col-span-3 md:order-first w-full">
      ...
      <section className="max-w-7xl px-4 py-4 sm:py-16 h-auto justify-center">
        <Card>
          <div className="grid gap-6 sm:gap-8 md:grid-cols-5 place-items-center">
            ...
            <div className="flex items-center justify-center md:col-span-3 w-full">
              {/* Eksempelbilde eller annet innhold */}
              <div className="relative w-full">
                <Image
        ...
        <Card>
          <div className="grid gap-6 sm:gap-8 md:grid-cols-5 place-items-center">
            <div className="md:col-span-2">
              ...
              <p className="mb-4 text-foreground-secondary text-base sm:text-lg leading-relaxed">
                Hver høst arrangerer TIHLDE en bedriftsekskursjon til Oslo med
      ...
      <section className="max-w-5xl px-4 py-12 sm:py-16 h-auto justify-center">
        <div className="md:col-span-2">
