...
const kursoOgWorkshop = `Et kurs introduserer studentene for relevante faglige erfaringer
                                til arbeidslivet. Det kan for eksempel være en spennende case, kodekurs, eller capture the flag. Dere kan tilpasse innholdet etter hvilke studenter som kommer. Vi legger til rette for matservering på skolen eller
...
const bedriftsekskursjon = `Hver høst arrangerer TIHLDE en bedriftsekskursjon til Oslo med
                            30 studenter. Dette gir bedrifter en god mulighet å vise frem lokalene sine og vise hvordan en typisk arbeidsdag hos dem ser ut. Etter
    ...
    <div className="relative flex flex-col items-center justify-center w-full overflow-x-clip">
      ...
      <section className="max-w-6xl px-4 py-12 sm:py-16 h-auto justify-center">
        <div className="md:col-span-2">
          <h2 className="mb-2 text-2xl sm:text-4xl font-bold">
            Stillingsannonser
          </h2>
      ...
      <section id="studiene" className="relative max-w-6xl px-4 py-12 sm:py-16">
            ...
            <Card key={line.title} className="p-4 sm:p-6 flex flex-col h-full">
              ...
              <div className="flex justify-end mt-4">
                <Button variant="link" className="">
                  <Link href="/studiene" className="flex items-center gap-2">
